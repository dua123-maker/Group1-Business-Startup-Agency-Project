...
# PROJECT DESCRIPTION:
This project is developed by Group 1 – Business Startup Agency as part of an academic requirement.
It represents a complete eCommerce Shoe Store website designed to simulate a real online business.
The project focuses on product showcasing, startup business planning, and digital selling concepts.
It also includes proper documentation, calculations, and presentation files to support the business model.
# GROUP MEMBERS:
- FAIZAN AHMAD (2025-CS-194)
...
# LINKED IN PROFILES
-FAIZAN AHMAD(https://www.linkedin.com/in/faizan-ahmed-150911386/)
-ABDULLAH WASIF(https://www.linkedin.com/in/abdullah-wasif-9b2b6939a/)
